<form class="relative flex items-center overflow-hidden rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900" method="GET" action="{{ route('recipes.search') }}">
    ...
    <button type="submit" class="p-2 bg-amber-500 dark:bg-amber-400 border border-transparent rounded-e-md font-semibold text-xs text-white dark:text-gray-800 uppercase tracking-widest hover:bg-amber-400 dark:hover:bg-white focus:bg-amber-400 dark:focus:bg-white active:bg-amber-600 dark:active:bg-amber-500 focus:outline-none transition ease-in-out duration-150">
