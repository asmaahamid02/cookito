<a href="{{ route('recipes', $recipe->id)}}" class="group text-gray-800 dark:text-gray-200 text-lg font-semibold capitalize">
    <div class="relative overflow-hidden rounded-xl shadow-lg">
        ...
        <div class="p-4 bg-white dark:bg-gray-900 bg-opacity-90">
            ...
            <h4 class="mt-1 text-2xl truncate group-hover:text-amber-600 dark:group-hover:text-amber-400">{{$recipe->title}}</h4>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400 truncate">By <span class="text-gray-700 dark:text-gray-500">{{$recipe->user->name}}</span></p>
